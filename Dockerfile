...
RUN mkdir /Jar && \
wget https://github.com/broadinstitute/gatk/releases/download/4.0.11.0/gatk-4.0.11.0.zip -O /Jar/gatk4.zip && \
...
ENV GATK_LOCAL_JAR=/Jar/gatk-package-4.0.11.0-local.jar
